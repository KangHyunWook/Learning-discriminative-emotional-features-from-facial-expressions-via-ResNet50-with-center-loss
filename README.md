...
Background: Although existing deep learning models are capable of learning separable features using softmax function, they suffer from intra-class variations when they do label predictions as illustrated in the left figure below.
